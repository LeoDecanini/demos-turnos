...
type Props = {
    ...
    /** Usamos la URL del backend para componer la foto: `${backendBaseUrl}/${path}` */
    backendBaseUrl: string;
    /** Alto opcional del contenedor scrollable */
    heightClassName?: string;
};

/**
 * Lista simple de profesionales (sin categorías).
 * - Foto circular a la izquierda (usa backendBaseUrl + path).
                            ...
                            >
                                ...
                                <div
                                    ...
                                    {imgSrc ? (
                                        ...
                                        <div
                                            className="h-full w-full flex items-center justify-center text-xs font-semibold text-gray-600">
                                            {initials(p.name)}
                                        </div>
                                    )}
                                </div>
