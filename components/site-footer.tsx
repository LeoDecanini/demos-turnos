                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-300 text-xs leading-relaxed mb-6">
                            Especialistas en medicina estética avanzada con más de 10 años de experiencia. Tratamientos seguros y
                    ...
                    <div>
                        <h3 className="text-xl font-semibold text-white mb-6 relative">
                            Navegación
                            <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-yellow-400 to-amber-500"></div>
                        </h3>
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={link.name}>
                                    ...
                                    >
                                        <span className="w-1 h-1 bg-yellow-400 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start group">
                                <div className="flex-shrink-0 w-10 h-10 bg-yellow-500/10 rounded-lg flex items-center justify-center group-hover:bg-yellow-500/20 transition-colors">
                ...
                <div className="mt-16 pt-8 border-t border-gray-800/50">
                    <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
                        <div className="text-center lg:text-left">
                            ...
                            <Link href={"https://moveup.digital/turnos"} target={"_blank"} className="flex items-center justify-center lg:justify-start mt-2">
                                {/*<span className="text-gray-400 text-sm mr-2">Sistema de Turnos desarrollado por</span>*/}
                                <span className="font-semibold bg-gradient-to-r from-yellow-500 to-amber-500 bg-clip-text text-transparent">Sistema de Turnos  por
